...
class ApiException(message: String) : RuntimeException(message) {
    constructor(message: String, code: Int) : this(getApiExceptionMessage(code, message)) {
        this.errorCode = code
    }
    ...
    companion object {
         ...
         * @return
         */
        private fun getApiExceptionMessage(code: Int, message: String): String {
            return when (code) {
                ...
                HttpStatus.REPEAT_LOGIN -> message
                else -> "请求失败，请稍后再试..."
            }
        }
    }
